...
DROP TABLE IF EXISTS projetos_tipos;
...
CREATE TABLE projetos_tipos (
  id SERIAL NOT NULL PRIMARY KEY UNIQUE,
  idtenant int NOT NULL,
  idprojeto int NOT NULL,
  idtipoprojeto int NOT NULL,
  CONSTRAINT fk_pt_projeto FOREIGN KEY (idprojeto) REFERENCES projetos (id) ON DELETE CASCADE,
  CONSTRAINT fk_pt_tipo_projeto FOREIGN KEY (idtipoprojeto) REFERENCES tipos_projetos (id),
  CONSTRAINT fk_pt_tenant FOREIGN KEY (idtenant) REFERENCES tenants (id)
);
...
CREATE TABLE plantas (
  ...
  imagem BYTEA,
  CONSTRAINT fk_planta_projeto_tipo FOREIGN KEY (idprojetotipo) REFERENCES projetos_tipos (id) ON DELETE CASCADE,
